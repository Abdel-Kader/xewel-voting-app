        ...
        if (choix != null && choix.nom && choix.type && choix.dateSeance) {
            ...
            if (!response.ok) {
                ...
                if(response.status == 201) {
                    ...
                    localStorage.setItem("vot_impro", 'true');
                    localStorage.setItem("date_impro", date);
                    // setNom('')
                    // setType('')
                    // setDateSeance('')
                }
            ...
            <div className="md:container flex justify-center">
                <div className="sm:w-full md:w-5/12 lg:w-5/12">
                    ...
                    <div className="border-2 p-4" style={{marginBottom: 50}}>
                        ...
                        {!vide ?
                            <>
                                <h1 className="text-xl h-16"><strong>Note : </strong>Choisissez votre meilleur improvisation
                                </h1>
                                {
                                    orateurs.map(value => (
                                ...
                                <br/>
                                {
                                    ( localStorage.getItem('vot_impro')&& localStorage.getItem('date_impro') == date ) ?
